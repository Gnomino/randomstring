...
parser.add_argument('-l', '--lowers', action='store_const', dest='lowers', const=string.lowercase, default='', help='Adds lower cases to the random string')
parser.add_argument('-u', '--uppers', action='store_const', dest='uppers', const=string.uppercase, default='', help='Adds upper cases to the random string')
